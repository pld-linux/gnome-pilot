...
%description -l da
GNOME stÂr for GNU Network Object Model Environment, GNU NetvÊrk
Objekt Model Milj¯. Et smart navn, men GNOME er i virkeligheden en
pÊnt GUI desktop milj¯. Det g¯r brugen af din computer nemmere,
kraftiger og nemmere at sÊtte op.

%description -l pl
GNOME pilot jest kolekcj± programÛw i demonÛw integruj±cych GNOME z
PalmPilotem(TM).
...
Biblioteki i pliki nag≥Ûwkowe gpilotd.
